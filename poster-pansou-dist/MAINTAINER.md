...
git remote add origin https://github.com/你的用户名/poster-pansou.git
git branch -M main
...
git remote add origin https://github.com/你的用户名/poster-pansou-dist.git
git branch -M main
git push -u origin main
```
...
```bash
cd /tmp
wget https://github.com/你的用户名/poster-pansou-dist/releases/download/v<VER>/poster-pansou-<VER>-docker.tar
...
git clone https://github.com/你的用户名/poster-pansou-dist.git /tmp/test
cd /tmp/test
bash install.sh
...
gh release create v0.43.12-r233-your-new-version poster-pansou-0.43.12-r233-your-new-version-docker.tar --repo 你的用户名/poster-pansou-dist
```